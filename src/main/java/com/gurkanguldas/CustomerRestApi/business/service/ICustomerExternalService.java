...
/**
 * Performs check operations for adding, deleting and getting customers.
 * 
 * @author Gurkan
 *
 */
public interface ICustomerExternalService {
	 ...
	 * @return ReturnModel is returned and the result value returns to the customer.
	 */
	ReturnModel<CustomerDto> addCustomer(CustomerDto customerDto, boolean name, boolean id,
