...
public class CustomExternalService implements ICustomerExternalService 
{
	...
	{
		ReturnModel<CustomerDto> model = new ReturnModel<CustomerDto>
		(true, "getCustomerById","Customer ID " + id + " was successfully returned.", null);
	...
	{
		return new ReturnModel<Set<CustomerDto>>
		(true, "getCustomers", "The customer list has been successfully called up.", customers);
	}
	...
	{
		ReturnModel<CustomerDto> model = new ReturnModel<CustomerDto>
		(true, "deleteCustomerById", "The customer with ID number " + id + " was deleted.", null);
