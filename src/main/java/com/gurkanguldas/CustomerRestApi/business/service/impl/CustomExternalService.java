...
public class CustomExternalService implements ICustomerExternalService {
	...
	public ReturnModel<CustomerDto> getCustomerById(Optional<Customer> customer, Long id) {
		...
		ReturnModel<CustomerDto> model = new ReturnModel<CustomerDto>(true, "getCustomerById",
				"Customer ID " + id + " was successfully returned.", null);
	...
	public ReturnModel<Set<CustomerDto>> getCustomers(Set<CustomerDto> customers) {
		...
		return new ReturnModel<Set<CustomerDto>>(true, "getCustomers",
				"The customer list has been successfully called up.", customers);
	}

	@Override
	public ReturnModel<CustomerDto> addCustomer(CustomerDto customerDto, boolean name, boolean id, BindingResult bindingResult) {
		
		ReturnModel<CustomerDto> model = new ReturnModel<CustomerDto>(true, "addCustomer",
				"Customer registration successful.", null);
	...
	public ReturnModel<CustomerDto> deleteCustomerById(Optional<Customer> customer, Long id) {
		ReturnModel<CustomerDto> model = new ReturnModel<CustomerDto>(true, "deleteCustomerById",
				"The customer with ID number " + id + " was deleted.", null);
