...
public interface ICustomerRestController {
	...
	@Operation(summary = CustomerSwaggerMessage.CUSTOMER_OPERATION_GET_ID_SUMMARY, description = CustomerSwaggerMessage.CUSTOMER_OPERATION_GET_ID_DESCRIPTION, security = @SecurityRequirement(name = "bearerAuth"))
	...
	@Operation(summary = CustomerSwaggerMessage.CUSTOMER_OPERATION_GET_ALL_SUMMARY, description = CustomerSwaggerMessage.CUSTOMER_OPERATION_GET_ALL_DESCRIPTION, security = @SecurityRequirement(name = "bearerAuth"))
	...
	@Operation(summary = CustomerSwaggerMessage.CUSTOMER_OPERATION_ADD_SUMMARY, description = CustomerSwaggerMessage.CUSTOMER_OPERATION_ADD_DESCRIPTION)
	...
	@Operation(summary = CustomerSwaggerMessage.CUSTOMER_OPERATION_DELETE_ID_SUMMARY, description = CustomerSwaggerMessage.CUSTOMER_OPERATION_DELETE_ID_DESCRIPTION, security = @SecurityRequirement(name = "bearerAuth"))
